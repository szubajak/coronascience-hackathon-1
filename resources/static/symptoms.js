...
export const SYMPTOM_DATA = [
  { symptom: {display: 'Husten', code: SYMPTOM_CODE.cough},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Müdigkeit', code: SYMPTOM_CODE.fatigue},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Hals\u00ADschmerzen', code: SYMPTOM_CODE.throatPain},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Atemnot in Ruhe', code: SYMPTOM_CODE.dyspnea},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Kopf\u00ADschmerzen', code: SYMPTOM_CODE.headache},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Durchfall', code: SYMPTOM_CODE.diarrhea},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Übelkeit', code: SYMPTOM_CODE.nausea},
    answerOptions: SYMPTOM_ANSWER_OPTIONS },
  { symptom: {display: 'Geruchs- / Geschmacks\u00ADverlust', code: SYMPTOM_CODE.anosmia},
    answerOptions: SYMPTOM_ANSWER_OPTIONS }
]
